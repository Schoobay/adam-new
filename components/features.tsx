...
import WorkoutPlan from "@/public/images/workout-plan.jpg";
import Nutrition from "@/public/images/nutrition.jpg";
import SportsPerformance from "@/public/images/sportsperfromance.jpg";
      ...
      <div className='relative max-w-6xl mx-auto px-4 sm:px-6'>
        <div className='pt-12 md:pt-20'>
          ...
          <div className='max-w-3xl mx-auto text-center pb-12 md:pb-16'>
            <h1 className='h2 mb-4'>Meet your trainer</h1>
            <p className='text-xl text-gray-600'>
              I'm Adam, a Certified Personal Trainer, With years of experience
              and a passion for fitness. My goal is to guide you on your fitness
              journey. Get ready to transform your life!
            </p>
          </div>
          ...
          <div className='md:grid md:grid-cols-12 md:gap-6'>
            ...
            {/* Tabs items */}
            <div className='max-w-xl md:max-w-none md:w-full mx-auto md:col-span-5 lg:col-span-6 mb-72 md:mb-0 md:order-1'>
